...
// ============================================================
// new01.ck — ii–V–I in D Major, Tonal Jazz, AABA 32-bar form
// ============================================================
...
AleatoricMelody saxMelody(sax, dMajorScale, 16, 8, saxProbs);
...
[
    ...
    0,
    DrumMachine.Clap(),       // beat 4
    0,
    DrumMachine.ClosedHat(),  // & of 4
    0
] @=> int drumNotes[];
NoteCollection drumNC(drumNotes);
["1.0"] @=> string drumProbs[];
[120] @=> int drumVelocities[];
...
// ============================================================
// Fragments — AABA straight-through (all transitions at 1.0)
// ============================================================
...
// fragA3 has no nextFragments — song ends after final A
...
// Song
// ============================================================
Song song("new01", BPM, root, fragA1, allParts);
