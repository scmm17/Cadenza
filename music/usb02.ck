...
// Global parameters
100 => float BPM;          // Beats per minute
...
V3GrandPiano piano(1, "E-Piano FM - note-off 4", 81);
...
[I7_Low, I7_Low, I7_Low, I7_Low, 
 IV7_Low, IV7_Low, I7_Low, I7_Low, 
 V7_Low, IV7_Low, I7_Low, I7_Low] @=> Chord chordsMelodyLow[];
...
[1.0, 0.0, 1.0, 1.0] @=> float probabilities1[];
[124, 90, 100, 90] @=> int velocities1[];
...
[1.0, 1.0, .05, .2] @=> float probabilities8[];
ChordProgression prog8(piano, chordsMelodyLow, progression, true, 16, 12, probabilities8);
[120, 100] @=> int velocities8[];
true => prog8.random;
// true => prog4.legato;
velocities8 @=> prog8.velocities;
.3 => prog8.mutateProbabilityRange;
...
ChordProgression prog2(sh4d_3, chordsL, progression, false, 1, 12, probabilities2);
...
RolandSH4d drumKit(10, "Drums", 40);
...
[prog2, prog, prog4, prog5, prog6, prog8, drums] @=> Part parts1[];
Fragment frag1("frag1", 1, parts1);
FragmentTransition ft1(frag1, 1.0);
[ft1] @=> frag1.nextFragments;
Song song("usb02", BPM, root, frag1, parts1);
