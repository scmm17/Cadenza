...
170 => float BPM;           // perceived 110 in 5/4 (88 = 110 * 4/5)
60 => int root;            // C4
...
[127, 0, 90, 0, 0] @=> int chorusBellsVel[];
ChordProgression chorusBells(bells, chordsStd, progression, true, 5, numBars, chorusBellsProbs);
...
// Bridge drums: kick only on quarter-note beats 1 and 3 (10 = quintuplet eighths per bar).
// Slot map matches chorus/pre-chorus drums — beat 1 = 0, beat 3 = 4.
[   "1.0",     // 1  kick
    "0.0",     //    &
    "0.0",     // 2
    "0.0",     //    &
    ...
    "0.0",     // 5
    "0.0"      //    &
] @=> string bridgeDrumProbs[];
[110, 0, 0, 0, 105, 0, 0, 0, 0, 0] @=> int bridgeDrumVel[];
[
    DrumMachine.ClosedHat(),
    DrumMachine.ClosedHat(),
    DrumMachine.ClosedHat(),
...
NoteCollection bridgeDrumNotesCollection(bridgeDrumNotes);
DrumMachine bridgeDrums(bridgeDrumNotesCollection, 10, numBars, bridgeDrumProbs, drumKit);
bridgeDrumVel @=> bridgeDrums.velocities;
0.0 => bridgeDrums.mutateProbabilityRange;

[bridgeVibe, bridgeMarimba, bridgeXylo, bridgeDrums] @=> Part bridgeParts[];
