...
// Midi devices
Hydrasynth hydrasynth("E021", 100);
RolandS1 s1(1, 13, 100);
...
[1.0, 0, .65, 0, .65, 0, .65, 0, 
 0.65, 0, .30, 0, .65, .35, 1.0, 1.0] @=> float probabilities1[];
[124, 100, 120, 100] @=> int velocities1[];
ChordProgression prog(s1, chordsH, progression, true, 32, 4, probabilities1);
...
Song song("plink04", BPM, root, frag, parts);
song.play();
