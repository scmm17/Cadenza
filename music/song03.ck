...
[127, 0, 134, 0, 94, 120, 120, 120] @=> int velocities3[];
[
...
FragmentTransition ft3_1(frag3, 0.5);
FragmentTransition ft3_2(frag2, 0.25);
FragmentTransition ft3_3(frag4, 0.25);

FragmentTransition ft4_1(frag4, 0.6);
FragmentTransition ft4_2(frag2, 0.1);
FragmentTransition ft4_3(frag5, 0.3);

FragmentTransition ft5_1(frag5, 0.5);
FragmentTransition ft5_2(frag4, 0.3);
FragmentTransition ft5_3(frag6, 0.2);

FragmentTransition ft6_1(frag6, 0.5);
FragmentTransition ft6_2(frag5, 0.25);
FragmentTransition ft6_3(frag4, 0.25);
