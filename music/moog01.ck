...
[1.0, 1.0] @=> float probabilitiesa[];
[1.0,0.2, 1.0, 0.3] @=> float probabilities1[];
[124, 75, 100, 60] @=> int velocities1[];
ChordProgression prog(moog, chordsBassH, progression, true, 16, 12, probabilities1);
velocities1 @=> prog.velocities;
ChordProgression prog6(s1, chordsBassH, progression, true, 16, 12, probabilitiesa);
...
RolandSH4d drumKit(10, "Drums", 60);
...
Song song("moog01", BPM, root, frag1, parts1);
