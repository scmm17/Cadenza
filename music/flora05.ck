...
[124] @=> int velocities1[];
ChordProgression prog1(hydrasynth, chordsH, progression, true, 16, 4, probabilities1);
...
Song song("flora05", BPM, root, frag1, parts1);
